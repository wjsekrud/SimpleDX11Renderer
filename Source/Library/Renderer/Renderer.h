...
#include "../Game/Light/RotatingPointLight.h"
#include "Shader/VertexShader.h"
#include "Shader/PixelShader.h"
#include "SkinningVertexShader.h"
...
public:
	...
	HRESULT AddPointLight(_In_ size_t index, _In_ const std::shared_ptr<Light>& pPointLight);
...
private:
	...
	std::vector<std::shared_ptr<PointLight>> m_aPointLights;
